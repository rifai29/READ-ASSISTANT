    ...
    <div className="h-[100dvh] bg-bg-main text-text-main font-sans flex overflow-hidden selection:bg-primary/20">
      ...
      <nav className="w-64 bg-bg-sidebar border-r border-border-subtle flex-col p-6 hidden lg:flex h-full">
        <div className="flex items-center gap-4 mb-12 group cursor-pointer" onClick={() => setActiveTab('library')}>
          <div className="w-12 h-12 bg-primary rounded-xl flex items-center justify-center shadow-[0_8px_20px_rgba(79,70,229,0.3)] transition-transform duration-500 group-hover:rotate-12 group-hover:scale-110">
        ...
        <header className="h-16 sm:h-24 bg-bg-main/80 backdrop-blur-md sticky top-0 z-40 border-b border-border-subtle shrink-0 flex items-center justify-center">
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 flex items-center justify-between">
            <div className="lg:hidden flex items-center gap-2 sm:gap-3">
               <div className="w-9 h-9 sm:w-10 sm:h-10 bg-primary rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg shadow-primary/20">
      ...
      {/* Mobile Bottom Nav */}
      <nav className="fixed bottom-4 sm:bottom-5 left-3 sm:left-4 right-3 sm:right-4 z-50 lg:hidden max-w-md mx-auto">
        <div className="bg-bg-card/90 backdrop-blur-xl border border-border-subtle/80 rounded-[22px] sm:rounded-[24px] shadow-[0_10px_30px_rgba(0,0,0,0.15)] px-2 sm:px-3 py-1 sm:py-1.5">
          <div className="flex items-center justify-between gap-0.5 sm:gap-1">
            {[
              ...
              <button
                ...
                className={cn(
                  "relative flex flex-col items-center justify-center py-1.5 sm:py-2 px-1 rounded-xl transition-all duration-300 w-full select-none outline-none",
              ...
              >
                ...
                <item.icon className={cn("w-[18px] h-[18px] sm:w-5 sm:h-5 transition-transform duration-300", activeTab === item.id && "scale-110")} />
                <span className="text-[8.5px] min-[375px]:text-[9.5px] sm:text-[10.5px] font-bold tracking-tight mt-0.5 sm:mt-1 truncate max-w-full text-center">{item.label}</span>
              </button>
            ))}
          </div>
        </div>
